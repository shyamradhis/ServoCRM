...
export const AccountsDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/accounts' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.accounts.delete.question">Are you sure you want to delete Accounts {accountsEntity.id}?</ModalBody>
      <ModalFooter>
